...
__global__ void _add_tensor_forward_cuda_kernel_unvectorized(const scalar_t *x,
                                                             const scalar_t *y,
                                                             scalar_t *output,
...
void add_tensor_forward_cuda(const torch::Tensor x,
    ...
    AT_DISPATCH_CUSTOM_FLOAT_TYPES(
        x.scalar_type(), "add_tensor_forward_cuda_kernel", ([&] {
            ...
            case 1:
                _add_tensor_forward_cuda_kernel_unvectorized<scalar_t><<<NUM_BLOCKS, BLOCK_SIZE>>>(
