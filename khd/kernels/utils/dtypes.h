...
template <> struct DType<fp32> {
    ...
    __device__ static nv_dtype upcast(const c10_dtype &value) { return value; }
    __device__ static nv_dtype upcast(const nv_dtype &value) { return value; }
    __device__ static nv_dtype2 upcast(const nv_dtype2 &value) { return value; }
    __device__ static nv_dtype4 upcast(const nv_dtype4 &value) { return value; }
