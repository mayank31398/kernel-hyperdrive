...
_KERNEL_NAME = "lightning_transformer_forward_cuda"


def lightning_transformer_forward_cuda_kernel(
...
def lightning_transformer_forward_cuda_kernel_compileable(
    x: torch.Tensor, y: torch.Tensor, output: torch.Tensor, vectorized_loop_size: int, BLOCK_SIZE: int
) -> None:
    lightning_transformer_forward_cuda_kernel(
