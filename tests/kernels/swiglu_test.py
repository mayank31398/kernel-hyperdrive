...
class SwigluTest(TestCommons):
    ...
    def test_swiglu(
        ...
        vectorized_instruction_width_forward: int,
        vectorized_instruction_width_backward: int,
        ...
        z_kernel = function(
            ...
            vectorized_instruction_width_forward=vectorized_instruction_width_forward,
            vectorized_instruction_width_backward=vectorized_instruction_width_backward,
